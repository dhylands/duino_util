...
//! An implementation of strncpy_s.
//! This is similar to strncpy but strncpy_s ensures that the result is null terminated.
//! @returns 0 if `src` fits into `dst`, ERANGE if `dst` gets truncated.
int strncpy_s(
